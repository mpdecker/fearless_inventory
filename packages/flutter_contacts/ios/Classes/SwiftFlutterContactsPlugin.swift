...
public class SwiftFlutterContactsPlugin: NSObject, FlutterPlugin, FlutterStreamHandler, CNContactViewControllerDelegate, CNContactPickerDelegate {
    ...
    public static func register(with registrar: FlutterPluginRegistrar) {
        ...
        // iOS 13+ uses UIWindowScene; the old delegate.window chain is nil
        // on SceneDelegate apps and crashes with a force-unwrap.
        ...
        if #available(iOS 13.0, *) {
            ...
            rootViewController = UIApplication.shared.delegate?.window??.rootViewController ?? UIViewController()
        }
