...
| --- | ------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------- |
| 1.1 | **Sign in with Apple** entitlement missing | **Portal (still required):** In [Apple Developer → Identifiers](https://developer.apple.com/account/resources/identifiers/list), enable **Sign In with Apple** for App ID `com.fearlessinventory.fearless_inventory`. In Xcode: **Runner** → **Signing & Capabilities** → confirm **Sign In with Apple** appears (entitlements file already has `com.apple.developer.applesignin` / `Default`).                                                                                                                                                                                       | Archive build; entitlements show Apple Sign In. Device: Apple sign-in completes and Firebase user exists. |
